...
//		if(this.emailbean.getIndexEnvelope().getDocument().get(0).getDocProducer().toString().equalsIgnoreCase("S6")){
//			env.setSourceSystem(obj.createEnvironmentDataSourceSystem("SYSTEM6"));
//		} else {
//			env.setSourceSystem(obj.createEnvironmentDataSourceSystem(this.emailbean.getIndexEnvelope().getDocument().get(0).getDocProducer()));
//		}
//		} else {
//			env.setSourceSystem(obj.createEnvironmentDataSourceSystem(""));
//		}
