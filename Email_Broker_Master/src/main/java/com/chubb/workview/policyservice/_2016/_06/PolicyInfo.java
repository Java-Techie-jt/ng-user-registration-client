...
@XmlType(name = "PolicyInfo", namespace = "http://Chubb.com/WorkView/PolicyService/2016/06", propOrder = {
    ...
    "stateID",
    "underwriterID",
    "northAmericanIndustrialClassificationSystemDetails"
})
public class PolicyInfo {
    ...
    @XmlElementRef(name = "NorthAmericanIndustrialClassificationSystemDetails", namespace = "http://Chubb.com/WorkView/PolicyService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<String> northAmericanIndustrialClassificationSystemDetails;

    
    
    public JAXBElement<String> getNorthAmericanIndustrialClassificationSystemDetails() {
		return northAmericanIndustrialClassificationSystemDetails;
	}

	public void setNorthAmericanIndustrialClassificationSystemDetails(
			JAXBElement<String> northAmericanIndustrialClassificationSystemDetails) {
		this.northAmericanIndustrialClassificationSystemDetails = northAmericanIndustrialClassificationSystemDetails;
	}
