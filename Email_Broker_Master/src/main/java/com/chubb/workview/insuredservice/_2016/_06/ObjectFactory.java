...
public class ObjectFactory {
    ...
    private final static QName _InsuredInfoRequestDunnsNumber_QNAME = new QName("http://Chubb.com/WorkView/InsuredService/2016/06", "DunnsNumber");
  ...
  //  private final static QName _GetInsuredRequestEnvironmentdata_QNAME = new QName("http://Chubb.com/WorkView/InsuredService/2016/06", "Environmentdata");
    ...
    @XmlElementDecl(namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", name = "DunnsNumber", scope = InsuredInfoRequest.class)
    public JAXBElement<String> createInsuredInfoRequestDunnsNumber(String value) {
        return new JAXBElement<String>(_InsuredInfoRequestDunnsNumber_QNAME, String.class, InsuredInfoRequest.class, value);
    }
