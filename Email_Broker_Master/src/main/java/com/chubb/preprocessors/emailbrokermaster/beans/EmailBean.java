...
private IndexType indexEnvelopee;
	...
	public IndexType getIndexEnvelopee() {
		return indexEnvelopee;
	}

	public void setIndexEnvelopee(IndexType indexEnvelopee) {
		this.indexEnvelopee = indexEnvelopee;
	}
}
