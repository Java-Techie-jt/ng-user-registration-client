...
public class InsuredDataType {
    ...
    @XmlElement(name = "PORTFOLIO_SEGMENT", required = false, nillable = true)
    protected String portfoliosegment;

    public String getPortfoliosegment() {
		return portfoliosegment;
	}

	public void setPortfoliosegment(String portfoliosegment) {
