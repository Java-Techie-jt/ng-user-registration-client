...
/**
 * <p>Java class for CorrespondentDetails complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CorrespondentDetails">
 *   &lt;complexContent>
...
@XmlType(name = "CorrespondentDetails", propOrder = {
    "correspondentID",
    "claimReference",
    "entityCode",
...
public class CorrespondentDetails {
    ...
    @XmlElementRef(name = "ClaimReference", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<String> claimReference;
    @XmlElement(name = "EntityCode", required = true, nillable = true)
    protected String entityCode;
    @XmlElementRef(name = "UnderWriterReference", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<String> underWriterReference;
    @XmlElementRef(name = "CorrespondentNumber", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<String> correspondentNumber;
    @XmlElementRef(name = "CorrespondentCompany", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<String> correspondentCompany;
    @XmlElementRef(name = "Position", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "Forename", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<String> forename;
    @XmlElementRef(name = "Middlename", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<String> middlename;
    @XmlElementRef(name = "EmailID", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "CorrespondentName", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<String> correspondentName;
    @XmlElementRef(name = "TitleDescription", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "BirthDate", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> birthDate;
    @XmlElementRef(name = "ContactName", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<String> contactName;
    @XmlElementRef(name = "OtherContactNumber", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "Title", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "MobileNumber1", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<String> mobileNumber1;
    @XmlElementRef(name = "TownCode", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<String> townCode;
    @XmlElementRef(name = "MobileNumber2", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<String> mobileNumber2;
    @XmlElementRef(name = "WorkNumber", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
    protected JAXBElement<String> workNumber;
    @XmlElement(name = "IsPreferred")
    protected Integer isPreferred;
    @XmlElementRef(name = "ContactMethodType", namespace = "http://Chubb.com/WorkView/InsuredService/2016/06", type = JAXBElement.class, required = false)
