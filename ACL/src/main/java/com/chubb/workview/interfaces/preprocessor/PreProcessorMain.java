...
public class PreProcessorMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            TimeZone.setDefault(TimeZone.getTimeZone("UTC"));//TODO Change the logic for time conversion
            ...
            if (!resources.isLoadBalanced()) {
                ...
                LOG.info("------------ACL Preprocessor Execution Process ENDS without High Availability settings.-----------");
            }
            ...
            //HighAvailability mode - Sync between the two nodes
                ...
                if (resources.getConnectionproperties().getProperty(SERVER_NAME).equalsIgnoreCase("server1")) {
                    ...
                    LOG.info("------------ACL Preprocessor Execution Process ENDS with High Availability settings.-----------");
                }
    ...
    private static void loadBalancerpropertyUpdate(Properties loadBalancerProperty, String serverName, String sharedPath) {
