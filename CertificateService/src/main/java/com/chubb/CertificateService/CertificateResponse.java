...
public class CertificateResponse {
    ...
    @XmlElement(name = "CertificateNumber", required = true, nillable = true)
    protected String certificateNumber;
    @XmlElement(name = "PolicyNumber", required = true, nillable = true)
    protected String policyNumber;
    @XmlElementRef(name = "Result", namespace = "http://Chubb.com/WorkView/CertificateService/2016/06", type = JAXBElement.class, required = false)
