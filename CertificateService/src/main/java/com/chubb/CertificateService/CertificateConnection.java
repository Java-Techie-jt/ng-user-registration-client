...
import com.chubb.CertificateService.Utilities.FileUtilities;
...
public class CertificateConnection
{
  ...
  public CertificateBean CreatePolicyConnection(CertificateBean cb)
  {
    ...
    try
    {
      ...
      String url = this.resources.getConnectionproperties().getProperty("Certificate_WebService");
    ...
    throws SOAPException
  {
    ...
    headerElement1.addTextNode(this.resources.getConnectionproperties().getProperty("Certificate_WebService"));
    ...
    element16.addTextNode(cb.getCertificateName());
    
    SOAPElement element17 = element15.addChildElement("ContactName", "ns1");
    element17.addTextNode(cb.getCertificateName());
    ...
    element11.addTextNode(cb.getCountryCode().toUpperCase());
    ...
    element13.addTextNode(cb.getSourceSystem());
    

    SOAPElement element51 = element3.addChildElement("WorkViewEnvironment", "ns2");
    element51.addTextNode(this.resources.getConnectionproperties().getProperty("WorkViewEnvironment"));
    SOAPElement element52 = element3.addChildElement("WorkViewLogonID", "ns2");
    element52.addTextNode(this.resources.getConnectionproperties().getProperty("WorkViewLogonID"));
